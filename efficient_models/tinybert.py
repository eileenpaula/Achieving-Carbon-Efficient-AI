...
if not os.path.exists("tinyresults.xlsx"):
    wb = Workbook()
    wb.save("tinyresults.xlsx")
...
wb = load_workbook("tinyresults.xlsx")
ws = wb.active
ws.append(["", ""])
...
wb.save("tinyresults.xlsx")
print("TinyBERT Baseline data added to tinyresults.xlsx")
