...
if not os.path.exists("distilresults.xlsx"):
    wb = Workbook()
    wb.save("distilresults.xlsx")
...
# Write data to Excel
wb = load_workbook("distilresults.xlsx")
ws = wb.active
ws.append(["", ""])
...
wb.save("distilresults.xlsx")
print("DistilBERT baseline added to distilresults.xlsx")
