...
if not os.path.exists("electraresults.xlsx"):
    wb = Workbook()
    wb.save("electraresults.xlsx")
...
wb = load_workbook("electraresults.xlsx")
ws = wb.active
ws.append(["", ""])
...
wb.save("electraresults.xlsx")
print("ELECTRA Baseline data added to electraresults.xlsx")
